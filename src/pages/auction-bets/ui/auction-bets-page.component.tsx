  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Ставки — {auction?.main.cargo_num}</h2>
      ...
      {sortedBets.length === 0 ? (
        ...
        <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
          <div className="overflow-x-auto">
            {/* Table header */}
            <div className="grid grid-cols-12 gap-4 px-5 py-3 bg-gray-50 border-b border-gray-200 text-xs font-medium text-gray-500 uppercase tracking-wider min-w-175">
              <button
                type="button"
...
function BetRow({ bet }: { bet: BetItem }) {
  ...
  return (
    <div
      className={`grid grid-cols-12 gap-4 px-5 py-3 border-b border-gray-100 last:border-0 text-sm ${
    ...
    >
      ...
      <div className="col-span-2 text-gray-600">{formatCurrency(bet.price_no_vat)}</div>
      <div className="col-span-2">
